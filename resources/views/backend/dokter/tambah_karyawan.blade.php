                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Tambah Karyawan</a></li>
                        </ol>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                            <div class="tab-pane" id="settings">
                                <form method="post" action="{{ route('karyawan.tambah') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                                    <img id="showImage" src="{{ url('public/upload/no_image.jpg') }}" class="rounded-circle avatar-lg img-thumbnail"
                        alt="profile-image">
                                                                </div>
                                                            </div>
                                    </div> <!-- end row -->
